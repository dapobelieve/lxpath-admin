"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.pluginOptionsHandler = void 0;var _themeOrder = _interopRequireDefault(require("./themeOrder.js"));function _interopRequireDefault(e) {return e && e.__esModule ? e : { default: e };}

const pluginOptionsHandler = exports.pluginOptionsHandler = (() => {
  let firstRun = true;
  return (options, addBase, themesObject, packageVersion) => {
    ...
    if (themes === "all") {
      ...
      _themeOrder.default.forEach((themeName) => {
